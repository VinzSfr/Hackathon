...
<div class="container-fluid">
    ...
    <form class="form-horizontal" method="POST" id="barcode">
        ...
        <div class="row text-center">
            <div class="col-md-6">
                ...
                if(isset($_POST['submit'])) {
                    ...
                    if($string != '') {
                        ...
                        echo "<center><img  src='barecodeTest.php?codetype=code39&size=50&text=".$string."&print=true'/></center>";
                    } else {
            ...
            <img  src="barecodeTest.php?text=testing" />
            <img  src="Test2barecode.php">
        </div>
    </form>
</div>
</body>
